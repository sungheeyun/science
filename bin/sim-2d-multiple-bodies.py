...
if __name__ == "__main__":
    ...
    ball_ur: RigidBall = RigidBall(1.0, (2.0, 2.0))
    ball_ll: RigidBall = RigidBall(5.0, (-2.0, -2.0))
    ball_lr: RigidBall = RigidBall(1.0, (2.0, -2.0))
    ...
    # forces
    spring_ul: Spring = Spring(4.0, 1.0, pin_ul, ball_ul)
    spring_ur: Spring = Spring(5.0, 1.0, pin_ur, ball_ur)
    spring_ll: Spring = Spring(10.0, 1.0, pin_ll, ball_ll)
    spring_lr: Spring = Spring(10.0, 1.0, pin_lr, ball_lr)

    spring_u: Spring = Spring(1.0, 1.0, ball_ul, ball_ur)
    spring_l: Spring = Spring(10.0, 1.0, ball_ll, ball_lr)
    spring_r: Spring = Spring(10.0, 1.0, ball_lr, ball_ur)
    spring_le: Spring = Spring(5.0, 1.0, ball_ll, ball_ul)

    springs: list[Spring] = [
        Spring(1.0, 1.0, pin_ul, ball_u, color="r"),
        Spring(1.0, 1.0, ball_u, ball_ur, color="r"),
        Spring(1.0, 1.0, ball_r, ball_ul, color="r"),
        Spring(1.0, 1.0, ball_r, ball_ll, color="r"),
        Spring(1.0, 1.0, ball_r, pin_lr, color="r"),
        Spring(1.0, 1.0, ball_r, pin_ur, color="r"),
    ]

    friction: FrictionalForce2D = FrictionalForce2D(1e0, (2.0, 2.0))
    gravity: GravityLike = GravityLike([0.0, -1.0])
